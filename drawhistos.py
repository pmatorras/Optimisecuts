...
controlvars=["evid_","btagW_","bvetoW_", "susyMstop_","susyMLSP__","is_SF_"]
flavours={'df':'-1','sf':'1'}
...
for var in variables:
    ...
    if opt.test==True and "MET_pt" not in var: continue
    btagVeto=False
        ...
        for fl in flavours:
            ...
            for sample in samples:
                ...
                for mstop in mStops:
                    ...
                    treevarmStop = var+sample+'>>'+histo+'_'+mstop
            ...
            if(True in [cont_T2tt,cont_ttbar]): continue
